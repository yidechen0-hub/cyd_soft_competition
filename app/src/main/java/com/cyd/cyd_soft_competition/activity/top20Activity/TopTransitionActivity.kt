package com.cyd.cyd_soft_competition.activity.top20Activity
...
import com.cyd.cyd_soft_competition.databinding.ActivityTopTransitionBinding


class TopTransitionActivity : AppCompatActivity() {

    private lateinit var binding: ActivityTopTransitionBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTopTransitionBinding.inflate(layoutInflater)
    ...
    private fun playForegroundVideoFromRaw() {
        ...
        // 1. 获取 raw 目录下视频的 Uri
        val videoUri = Uri.parse("android.resource://${packageName}/${R.raw.top_transition}")
